  ...
  <div id="header"><div class="section clearfix">
    ...
    <div id="header-content" class="clearfix">
      ...
      <div id="section-description">
        <h2 id="section-title" class="section-description element-invisible"><?php if ($section_title) : print render($section_title); endif; ?></h2>
        <h3 id="section-desc" class="section-description element-invisible"><?php if ($section_desc) : print render($section_desc); endif; ?></h3>
      </div>
    </div>
