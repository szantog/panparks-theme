...
function panparks_preprocess_html(&$vars, $hook) {
  ...
  if (arg(1) == 'add' && arg(2) == 'photo-shared') {
    drupal_add_js('jQuery(document).ready(function () { jQuery("div#OpenLayers.Control.EditingToolbar_26 > div.olControlModifyFeatureItemInactive").trigger("click"); });', 'inline');
  }
}
// */
