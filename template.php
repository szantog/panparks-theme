...
/**
 * Overriden theme_colorbox_image_formatter
 * We need this, because of when using shared photos width colorbox, need to load the complete node, not only image
 ...
 * @ingroup themeable
 */
function panparks_colorbox_image_formatter($variables) {
  $item = $variables['item'];
  $node = $variables['node'];
  ...
  //This is our overrides. In every photo share node set the link to own node page content, and because of it's rendered
